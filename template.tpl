...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Contentsquare - Custom Errors",
  "categories": [
    "ANALYTICS"
  ],
  "brand": {
  ...
  "description": "Send custom errors to Contentsquare",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "LABEL",
    "name": "error_label",
    "displayName": "Error Message (Required)"
  },
  {
    "type": "TEXT",
    "name": "error_message",
  ...
  {
    "type": "GROUP",
    "name": "additional_error_attributes_label",
    "displayName": "",
    "groupStyle": "NO_ZIPPY",
    "subParams": [
      {
        "type": "LABEL",
        "name": "attributes",
        "displayName": "Additional Error Attributes (Optional)"
      },
      {
        "type": "SIMPLE_TABLE",
        "name": "attributes_array",
        "displayName": "These attributes can help categorize the error. Max 5 can be set.",
        "simpleTableColumns": [
          {
            "defaultValue": "",
...
const attributes_array = data.attributes_array;

let attributes = {};

if (attributes_array && attributes_array.length) {
    for (var i = 0; i < attributes_array.length; i++) {
        const key = attributes_array[i].attribute_name;
        const value = attributes_array[i].attribute_value;
...
Created on 9/26/2025, 10:19:33 AM
